<template>
  <div class="criar-moderador-page">
    <div class="criar-moderador-container">
          ...
          <form @submit.prevent="onCriar" class="criar-moderador-form">
            ...
            <div class="criar-moderador-form-group">
              ...
              <input
                ...
                required
                class="criar-moderador-form-control"
                placeholder="moderador@cursorstudio.com"
              />
            </div>
      ...
      <!-- Informações sobre o papel do moderador -->
...
import { criarModerador } from '../../../services/api/users'
...
async function onCriar() {
  ...
  try {
    await criarModerador({ name: nome.value, email: email.value, password: senha.value })
